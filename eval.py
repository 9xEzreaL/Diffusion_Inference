    ...
    try:
        ...
        for running_time in range(opt["sample_times"]):
            if opt['phase'] == 'train':
                ...
                for phase_data in tqdm.tqdm(phase_loader):
                    model.test(phase_data, running_time, opt["guided_step"])
                    # If you don't want save automatically, you can call model.output ... for further analysis
                    # print(model.output.shape)
                    # print(model.cond_image.shape)
                    # print(model.gt_image.shape)
